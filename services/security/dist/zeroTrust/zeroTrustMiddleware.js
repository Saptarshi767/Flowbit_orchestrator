...
exports.zeroTrustMiddleware = exports.ZeroTrustMiddleware = void 0;
const zeroTrustEngine_1 = require("./zeroTrustEngine");
...
class ZeroTrustMiddleware {
    ...
    evaluate(resource, action) {
        return async (req, res, next) => {
            try {
                ...
                // Evaluate access
                const decision = await zeroTrustEngine_1.zeroTrustEngine.evaluateAccess(evaluationResource, evaluationAction, context);
    ...
    continuousVerification() {
        return async (req, res, next) => {
            ...
            if (timeSinceLastCheck > 5 * 60 * 1000) {
                ...
                const decision = await zeroTrustEngine_1.zeroTrustEngine.evaluateAccess(req.path, req.method.toLowerCase(), updatedContext);
                if (!decision.allowed) {
                    return res.status(403).json({
    ...
    buildSecurityContext(req) {
        ...
        return {
            userId: req.user?.id,
            sessionId: req.sessionId || req.sessionID || 'anonymous',
            deviceFingerprint,
    ...
    addSecurityHeaders(res, trustScore) {
...
exports.ZeroTrustMiddleware = ZeroTrustMiddleware;
exports.zeroTrustMiddleware = new ZeroTrustMiddleware();
//# sourceMappingURL=zeroTrustMiddleware.js.map